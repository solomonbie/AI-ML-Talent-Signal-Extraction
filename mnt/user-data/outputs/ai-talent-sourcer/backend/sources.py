...
def search_github_repos(topic: str, max_results: int = 10):
    ...
    params = {
        # Deliberately NOT matching in:readme — readme text matches are too
        # loose and let huge, unrelated repos (e.g. massive "awesome" list
        # repos that happen to mention the topic once) dominate rankings
        # purely on their overall star count, drowning out people actually
        # doing relevant work. Name/description is a much stronger signal
        # that the repo is actually ABOUT the topic.
